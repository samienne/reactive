...
namespace bqui::remote
{
    ...
    private:
        ...
        // The run-loop path keeps one overlapped read pending so readEvent_
        // stays waitable; fillReady() reaps it and re-issues the next.
        OVERLAPPED readyOverlapped_{};
