...
{
    /**
     * @brief Replace the widget's introspection with the given (reactive) value,
     * keeping the instance's realised obb.
     *
     * The full escape hatch; the more specific modifiers below build on it.
     */
